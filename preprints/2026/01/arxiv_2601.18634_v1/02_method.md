...
taxonomy:
  ...
  horizons: []
  themes: []
title: 'The Compounded BSDE method: A fully-forward method for option pricing and
  optimal stopping problems in finance'
url_abs: http://arxiv.org/abs/2601.18634v1
url_html: https://arxiv.org/html/2601.18634v1
venue: arXiv q-fin
version: 1
year: 2026
---
...
Keywords: Compound BSDE method, reflected BSDE, option pricing, optimal stopping.

## 1 Introduction

Option pricing is a central topic in financial mathematics, especially for derivatives with complex payoff structures, early-exercise features, or high-dimensional underlying dynamics. Over the past decades, a wide range of numerical methods has been developed to address these challenges. Without attempting to provide an exhaustive overview, we mention partial differential equation (PDE) based methods [[1](https://arxiv.org/html/2601.18634v1#bib.bib1), [2](https://arxiv.org/html/2601.18634v1#bib.bib2), [3](https://arxiv.org/html/2601.18634v1#bib.bib3)], Fourier-based techniques such as the COS method [[4](https://arxiv.org/html/2601.18634v1#bib.bib4), [5](https://arxiv.org/html/2601.18634v1#bib.bib5)], and Monte Carlo regression-based approaches [[6](https://arxiv.org/html/2601.18634v1#bib.bib6), [7](https://arxiv.org/html/2601.18634v1#bib.bib7)].

In addition to these approaches, backward stochastic differential equations (BSDEs) [[8](https://arxiv.org/html/2601.18634v1#bib.bib8)] provide a flexible framework for option pricing. Via the Feynman–Kac representation [[9](https://arxiv.org/html/2601.18634v1#bib.bib9)], a pricing problem can be reformulated as a BSDE and solved numerically. A broad class of numerical schemes for BSDEs and forward–backward SDEs (FBSDEs) has been developed and analyzed; see, for example, [[10](https://arxiv.org/html/2601.18634v1#bib.bib10), [11](https://arxiv.org/html/2601.18634v1#bib.bib11), [12](https://arxiv.org/html/2601.18634v1#bib.bib12), [13](https://arxiv.org/html/2601.18634v1#bib.bib13), [14](https://arxiv.org/html/2601.18634v1#bib.bib14), [15](https://arxiv.org/html/2601.18634v1#bib.bib15)]. More recently, machine-learning-based approaches have attracted considerable interest due to their ability to address high-dimensional problems, including the deep BSDE method [[16](https://arxiv.org/html/2601.18634v1#bib.bib16), [17](https://arxiv.org/html/2601.18634v1#bib.bib17)], deep splitting [[18](https://arxiv.org/html/2601.18634v1#bib.bib18)], and deep backward dynamic programming [[19](https://arxiv.org/html/2601.18634v1#bib.bib19)], as well as related variants [[20](https://arxiv.org/html/2601.18634v1#bib.bib20), [21](https://arxiv.org/html/2601.18634v1#bib.bib21), [22](https://arxiv.org/html/2601.18634v1#bib.bib22)].

Reflected BSDEs provide a natural framework for pricing American- and Bermudan-style options; see, for example, [[23](https://arxiv.org/html/2601.18634v1#bib.bib23), [24](https://arxiv.org/html/2601.18634v1#bib.bib24), [25](https://arxiv.org/html/2601.18634v1#bib.bib25), [26](https://arxiv.org/html/2601.18634v1#bib.bib26), [19](https://arxiv.org/html/2601.18634v1#bib.bib19), [27](https://arxiv.org/html/2601.18634v1#bib.bib27)] for numerical methods for solving this type of BSDE. These approaches share a similar philosophy with the least-squares Monte Carlo method [[6](https://arxiv.org/html/2601.18634v1#bib.bib6)]: one simulates the underlying dynamics forward in time and then optimizes backward. In a recent contribution [[28](https://arxiv.org/html/2601.18634v1#bib.bib28)], a backward variant of the deep BSDE method is proposed, in which the loss functional is replaced by the variance of the initial value of the YY process. Numerical results suggest that this approach may be applicable to Bermudan option pricing. However, the convergence of this method for pricing early-exercise options has not been established and remains an open problem.
...
* •
  ...
  We introduce the compound BSDE, a new BSDE formulation with a wide range of financial applications, in particular for option pricing and optimal stopping. The formulation is inspired by the payoff structure of compound options. A detailed discussion of this class of exotic options and their connection to our framework is provided in Section [4](https://arxiv.org/html/2601.18634v1#S4 "4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance").
* •
...
The remainder of the paper is organized as follows. In Section [2](https://arxiv.org/html/2601.18634v1#S2 "2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), we introduce the compound BSDE formulation and the associated numerical method. In Section [3](https://arxiv.org/html/2601.18634v1#S3 "3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), we discuss well-posedness of the formulation and establish convergence of the proposed method. Section [4](https://arxiv.org/html/2601.18634v1#S4 "4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") explains how the compound BSDE framework can be applied to various option pricing and optimal stopping problems. Numerical results are presented in Section [5](https://arxiv.org/html/2601.18634v1#S5 "5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"). Section [6](https://arxiv.org/html/2601.18634v1#S6 "6 Conclusion ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") concludes the paper.
...
where W≔{Wt}0≤t≤TW\coloneqq\{W\_{t}\}\_{0\leq t\leq T} is a Brownian motion, and μ\mu, σ\sigma, gg, and ff are deterministic functions. The solution of ([2.1](https://arxiv.org/html/2601.18634v1#S2.E1 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) is a triple of adapted processes
...
where ‖x‖\|x\| denotes the Euclidean norm if xx is a vector or the Frobenius norm if xx is a matrix, Δ​Wti≔Wti+1−Wti\Delta W\_{t\_{i}}\coloneqq W\_{t\_{i+1}}-W\_{t\_{i}} is the Brownian increment, π\pi denotes a uniform partition of [0,T][0,T] with step size hh. The quantities 𝒴t0π\mathcal{Y}\_{t\_{0}}^{\pi} and 𝒵tiπ\mathcal{Z}\_{t\_{i}}^{\pi} are parameterized by neural networks and serve as approximations of 𝒴t0\mathcal{Y}\_{t\_{0}} and 𝒵ti\mathcal{Z}\_{t\_{i}}, respectively. The objective functional ([2.2a](https://arxiv.org/html/2601.18634v1#S2.E2.1 "In 2.2 ‣ 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) acts as the loss function during the training of neural networks, and enforces the terminal condition 𝒴T=g​(𝒳T)\mathcal{Y}\_{T}=g(\mathcal{X}\_{T}).

Two properties of ([2.2](https://arxiv.org/html/2601.18634v1#S2.E2 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) are particularly relevant for our development. First, as noted in [[17](https://arxiv.org/html/2601.18634v1#bib.bib17)], the initial state 𝒳t0π\mathcal{X}\_{t\_{0}}^{\pi} need not be deterministic, but may be any square-integrable random variable. In this case, 𝒴t0π\mathcal{Y}\_{t\_{0}}^{\pi} learns the dependence on the distribution of 𝒳t0π\mathcal{X}\_{t\_{0}}^{\pi} rather than a fixed constant. Second, convergence of the method depends primarily on how small the objective function value is, and does not depend explicitly on 𝒴t0π\mathcal{Y}\_{t\_{0}}^{\pi}. We remark that when 𝒳t0π\mathcal{X}\_{t\_{0}}^{\pi} is random, the backward deep BSDE method of [[28](https://arxiv.org/html/2601.18634v1#bib.bib28)] cannot be applied directly, since the property Var⁡(𝒴0)=0\operatorname{Var}(\mathcal{Y}\_{0})=0 no longer holds.
...
In this section, we first address the well-posedness of the compound BSDE formulation ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) and collect the L2L^{2}-regularity properties needed in the convergence analysis. Combining these results with the *a posteriori* error estimate for the deep BSDE method applied to ([2.1](https://arxiv.org/html/2601.18634v1#S2.E1 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), we then obtain a concise convergence proof for the Compound BSDE method ([2.4](https://arxiv.org/html/2601.18634v1#S2.E4 "In 2.4 The Compound BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")).

###### Assumption 1.

The coefficients in ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) satisfy the following conditions.
...
Let Assumption [1](https://arxiv.org/html/2601.18634v1#Thmassumption1 "Assumption 1. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") hold. Then we have the following.

1. (i).

   The compound BSDE ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) admits a unique adapted solution (X,Y,Z)(X,Y,Z).
2. (ii).
...
3. (iii).
   ...
   If we additionally assume that uj∈C1,2​([Tj−1,Tj]×ℝd1,ℝd2)u\_{j}\in C^{1,2}([T\_{j-1},T\_{j}]\times\mathbb{R}^{d\_{1}},\mathbb{R}^{d\_{2}}), then the PDE ([3.2](https://arxiv.org/html/2601.18634v1#S3.E2 "In item (ii). ‣ Theorem 3.1. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) holds in the classical sense, and we have, for all jj,
...
Using the well-posedness results, we can further derive L2L^{2}-regularity estimates for the solution (X,Y,Z)(X,Y,Z) of ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) based on classical BSDE theory [[30](https://arxiv.org/html/2601.18634v1#bib.bib30), [29](https://arxiv.org/html/2601.18634v1#bib.bib29)]. To simplify the subsequent analysis, we impose Assumption [2](https://arxiv.org/html/2601.18634v1#Thmassumption2 "Assumption 2. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), which ensures that the process ZZ admits a càdlàg modification. For notational convenience, recall the uniform partition π\pi, we define the projection map π​(t)=ti\pi(t)=t\_{i} for t∈[ti,ti+1)t\in[t\_{i},t\_{i+1}).

###### Assumption 2.

The diffusion coefficient σ​(t,x)\sigma(t,x) in ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) satisfies one of the following conditions: either σ​(t,x)\sigma(t,x) is uniformly Lipschitz continuous in tt, or dimensions d1=d3d\_{1}=d\_{3} and the uniform ellipticity condition σ​(t,x)​σ​(t,x)⊤≥δ​𝐈d1\sigma(t,x)\sigma(t,x)^{\top}\geq\delta\mathbf{I}\_{d\_{1}} holds for some constant δ>0\delta>0.

###### Theorem 3.2 (L2L^{2}-regularity).

Let Assumptions [1](https://arxiv.org/html/2601.18634v1#Thmassumption1 "Assumption 1. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") and [2](https://arxiv.org/html/2601.18634v1#Thmassumption2 "Assumption 2. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") hold, and (X,Y,Z)(X,Y,Z) be the solution to the compound BSDE ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). For each j=1,2,…,Mj=1,2,\dots,M, the jj-th BSDE, together with the associated forward process XtX\_{t} on [Tj−1,Tj][T\_{j-1},T\_{j}], satisfies the following regularity estimate,
...
In what follows, we first present a proof for the deep BSDE method for equations of the form ([2.1](https://arxiv.org/html/2601.18634v1#S2.E1 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), as this will serve as the main building block for establishing our Compound BSDE framework. We note that rigorous analyses of related methods have already been carried out in more complex settings, e.g. coupled forward–backward stochastic differential equations [[17](https://arxiv.org/html/2601.18634v1#bib.bib17), [22](https://arxiv.org/html/2601.18634v1#bib.bib22)], BSDEs with jumps [[31](https://arxiv.org/html/2601.18634v1#bib.bib31)], BSDEs with non-Lipschitz coefficients [[32](https://arxiv.org/html/2601.18634v1#bib.bib32)], and mean-field type equations [[33](https://arxiv.org/html/2601.18634v1#bib.bib33)]. In contrast, our objective here is to provide a streamlined and self-contained proof for the basic case. This allows us to emphasize the essential ideas of our Compound BSDE method, while avoiding many of the technical conditions and complications that arise in the complex setting, particularly those associated with an implicit scheme for the BSDE.

The following assumption forms part of the sufficient conditions for convergence, and we shall further discuss it in a later remark. We also recall that the deep BSDE method ([2.2](https://arxiv.org/html/2601.18634v1#S2.E2 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) is a special case of the Compound BSDE method ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) with M=1M=1, where all the subscripts jj are omitted as they are not needed for M=1M=1. This observation clarifies the use of the assumptions in Theorem [3.3](https://arxiv.org/html/2601.18634v1#S3.Thmtheorem3 "Theorem 3.3 (A posteriori error estimate for the deep BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") below.
...
Let Assumptions [1](https://arxiv.org/html/2601.18634v1#Thmassumption1 "Assumption 1. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), [2](https://arxiv.org/html/2601.18634v1#Thmassumption2 "Assumption 2. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), and [3](https://arxiv.org/html/2601.18634v1#Thmassumption3 "Assumption 3. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") hold for the BSDE ([2.1](https://arxiv.org/html/2601.18634v1#S2.E1 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). Let (𝒳,𝒴,𝒵)(\mathcal{X},\mathcal{Y},\mathcal{Z}) denote its solution, and let (𝒳π,𝒴π,𝒵π)(\mathcal{X}^{\pi},\mathcal{Y}^{\pi},\mathcal{Z}^{\pi}) generated by the deep BSDE method ([2.2](https://arxiv.org/html/2601.18634v1#S2.E2 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). Then the method satisfies the following *a posteriori* error estimate,
...
If there is no direct access to g​(𝒳T)g(\mathcal{X}\_{T}), it can be replaced by g​(𝒳Tπ)g\!\left(\mathcal{X}\_{T}^{\pi}\right) on the right-hand side of ([3.7](https://arxiv.org/html/2601.18634v1#S3.E7 "In Theorem 3.3 (A posteriori error estimate for the deep BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")).
...
where we used Theorem [3.2](https://arxiv.org/html/2601.18634v1#S3.Thmtheorem2 "Theorem 3.2 (𝐿²-regularity). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") for the L2L^{2}-regularity of 𝒳\mathcal{X} and 𝒴\mathcal{Y} in the second and forth inequalities, respectively.

Consequently, using Itô isometry and ([3.10](https://arxiv.org/html/2601.18634v1#S3.E10 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), for 0≤i≤N0\leq i\leq N we have,
...
Taking the maximum over 0≤i≤N−10\leq i\leq N-1 on the left-hand side of the above inequality, and assuming that 6​T2​Ky2<16T^{2}K\_{y}^{2}<1, which is ensured when Assumption [3](https://arxiv.org/html/2601.18634v1#Thmassumption3 "Assumption 3. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") holds to a sufficient extent, we can rearrange the terms to obtain
...
It now remains to bound the second and third terms on the right-hand side of ([3.12](https://arxiv.org/html/2601.18634v1#S3.E12 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) in terms of the objective functional
𝔼​‖g​(𝒳T)−𝒴Tπ‖2\mathbb{E}\bigl\|g(\mathcal{X}\_{T})-\mathcal{Y}\_{T}^{\pi}\bigr\|^{2} used in the deep BSDE method ([2.2](https://arxiv.org/html/2601.18634v1#S2.E2 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). Recall that g​(𝒳T)=𝒴Tg(\mathcal{X}\_{T})=\mathcal{Y}\_{T}, then we can derive
...
Since our goal is to bound the terms 𝔼​‖Δ​𝒴t0‖2\mathbb{E}\left\|\Delta\mathcal{Y}\_{t\_{0}}\right\|^{2} and 𝔼​∫t0T‖Δ​𝒵s‖2​ds\mathbb{E}\int\_{t\_{0}}^{T}\|\Delta\mathcal{Z}\_{s}\|^{2}\mathrm{d}s in terms of 𝔼​‖g​(𝒳T)−𝒴Tπ‖2\mathbb{E}\left\|g(\mathcal{X}\_{T})-\mathcal{Y}\_{T}^{\pi}\right\|^{2}, we choose 0<ϵ<10<\epsilon<1 and 0<δ<10<\delta<1 so that the corresponding coefficients are positive. Then, using ([3.10](https://arxiv.org/html/2601.18634v1#S3.E10 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), ([3.12](https://arxiv.org/html/2601.18634v1#S3.E12 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), and noticing that (1−ϵ−1−δ−1)<0(1-\epsilon^{-1}-\delta^{-1})<0, we have
...
Substituting this lower bound into to ([3.13](https://arxiv.org/html/2601.18634v1#S3.E13 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) yields,

|  |  |  |  |  |
| --- | --- | --- | --- | --- |
|  | 𝔼​‖g​(𝒳T)−𝒴Tπ‖2\displaystyle\mathbb{E}\left\|g(\mathcal{X}\_{T})-\mathcal{Y}\_{T}^{\pi}\right\|^{2} | ≥(1−ϵ−1−δ−1)​C​h+[1−ϵ+(1−ϵ−1−δ−1)​(2​T2​Ky2​31−6​T2​Ky)]​𝔼​‖Δ​𝒴t0‖2\displaystyle\geq(1-\epsilon^{-1}-\delta^{-1})Ch+\left[1-\epsilon+(1-\epsilon^{-1}-\delta^{-1})\left(2T^{2}K\_{y}^{2}\frac{3}{1-6T^{2}K\_{y}}\right)\right]\mathbb{E}\left\|\Delta\mathcal{Y}\_{t\_{0}}\right\|^{2} |  | (3.15) |
...
in ([3.15](https://arxiv.org/html/2601.18634v1#S3.E15 "In Proof. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) must be positive. In addition to the conditions
0<ε<10<\varepsilon<1 and 0<δ<10<\delta<1, this leads to the following conditions

|  |  |  |  |
| --- | --- | --- | --- |
|  | (1−ϵ−1−δ−1)​(T​Kz2+2​T2​Ky2​3+3​T​Kz21−6​T2​Ky2)+1−δ>0,1−ϵ+(1−ϵ−1−δ−1)​(2​T2​Ky2​31−6​T2​Ky2)>0(1-\epsilon^{-1}-\delta^{-1})\left(TK\_{z}^{2}+2T^{2}K\_{y}^{2}\frac{3+3TK\_{z}^{2}}{1-6T^{2}K\_{y}^{2}}\right)+1-\delta>0,\quad 1-\epsilon+(1-\epsilon^{-1}-\delta^{-1})\left(2T^{2}K\_{y}^{2}\frac{3}{1-6T^{2}K\_{y}^{2}}\right)>0 |  | (3.16) |
...
Let Assumptions [1](https://arxiv.org/html/2601.18634v1#Thmassumption1 "Assumption 1. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), [2](https://arxiv.org/html/2601.18634v1#Thmassumption2 "Assumption 2. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), and [3](https://arxiv.org/html/2601.18634v1#Thmassumption3 "Assumption 3. ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") hold, and (X,Y,Z)(X,Y,Z) be the solution to ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). Then the approximated solution (Xπ,Yπ,Zπ)(X^{\pi},Y^{\pi},Z^{\pi}) obtained by the Compound BSDE method ([2.4](https://arxiv.org/html/2601.18634v1#S2.E4 "In 2.4 The Compound BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) satisfies the following *a posteriori* error estimate,
...
|  |  | ≤C​(h+∑j=1M−1𝔼​‖gj​(XTjπ,Yj+1,Tjπ)−Yj,Tjπ‖2+𝔼​‖gM​(XTπ)−YM,Tπ‖2),\displaystyle\hskip 170.71652pt\leq C\left(h+\sum\_{j=1}^{M-1}\mathbb{E}\|g\_{j}(X\_{T\_{j}}^{\pi},Y\_{j+1,T\_{j}}^{\pi})-Y\_{j,T\_{j}}^{\pi}\|^{2}+\mathbb{E}\|g\_{M}(X\_{T}^{\pi})-Y\_{M,T}^{\pi}\|^{2}\right), |  |

where CC is a constant independent of the step size hh.

###### Proof.

We apply Theorem [3.7](https://arxiv.org/html/2601.18634v1#S3.E7 "In Theorem 3.3 (A posteriori error estimate for the deep BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") to the jj-th BSDE in the Compound BSDE formulation ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), for j=1,2,…,M−1j=1,2,\ldots,M-1,
...
where CC denote a generic constant that may change from line to line, and we use the triangle inequality in the second inequality to split the term, since we do not have access to Yj+1,TjY\_{j+1,T\_{j}}, which is part of the solution of ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) that needs to be solved for. The remaining derivations follow from the Lipschitz continuity of gjg\_{j} and the L2L^{2}-regularity of the XX process.

For the case j=Mj=M, note that typically we have access to the samples for gM​(XTπ)g\_{M}(X\_{T}^{\pi}) via numerical methods for the SDE of XX, and thus applying Theorem [3.7](https://arxiv.org/html/2601.18634v1#S3.E7 "In Theorem 3.3 (A posteriori error estimate for the deep BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") again gives,
...
With gj​(x,y)=yg\_{j}(x,y)=y, the compound BSDE ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) collapses to a standard BSDE of the form ([2.1](https://arxiv.org/html/2601.18634v1#S2.E1 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), and the method ([2.4](https://arxiv.org/html/2601.18634v1#S2.E4 "In 2.4 The Compound BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) reduces to the classical deep BSDE method ([2.2](https://arxiv.org/html/2601.18634v1#S2.E2 "In 2.1 Review of the deep BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). Indeed, the intermediate loss terms
...
Such equations are typically solved in a backward manner; see the references discussed in Section [1](https://arxiv.org/html/2601.18634v1#S1 "1 Introduction ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance").

Comparing ([4.2](https://arxiv.org/html/2601.18634v1#S4.E2 "In Remark 3. ‣ 4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) with the compound BSDE formulation ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), we observe that the reflection operator ℛj−1\mathcal{R}\_{j-1} plays essentially the same role as the function gj−1g\_{j-1} in our framework. From this viewpoint, our method can also be interpreted as a numerical scheme for discretely reflected BSDEs of the form ([4.2](https://arxiv.org/html/2601.18634v1#S4.E2 "In Remark 3. ‣ 4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) with Lipschitz ℛj−1\mathcal{R}\_{j-1}. Moreover, the reason why our algorithm can be implemented in a forward training manner becomes clear from this perspective: instead of enforcing the hard constraint via directly computing

|  |  |  |
| --- | --- | --- |
|  | YTj−1=ℛj−1​(XTj−1,Y~Tj−1),Y\_{T\_{j-1}}=\mathcal{R}\_{j-1}\!\big(X\_{T\_{j-1}},\widetilde{Y}\_{T\_{j-1}}\big), |  |

as done, for example, by the max method in [[23](https://arxiv.org/html/2601.18634v1#bib.bib23)], or methods in [[28](https://arxiv.org/html/2601.18634v1#bib.bib28)] [[19](https://arxiv.org/html/2601.18634v1#bib.bib19)], we adopt a relaxed formulation by incorporating this reflection relation into the objective functional.
...
We also investigate the accuracy of the bound in ([3.17](https://arxiv.org/html/2601.18634v1#S3.E17 "In Theorem 3.4 (Convergence of the Compound BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")). When a reference (analytical or highly accurate) solution (X,Y,Z)(X,Y,Z) to ([2.3](https://arxiv.org/html/2601.18634v1#S2.E3 "In 2.3 Definition of the compound BSDE ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) is available, we report the following error metrics for the numerical solution (Xπ,Yπ,Zπ)(X^{\pi},Y^{\pi},Z^{\pi}) generated by the Compound BSDE method ([2.4](https://arxiv.org/html/2601.18634v1#S2.E4 "In 2.4 The Compound BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")),
...
|  |  | Err⁡(Z)≔∑j=1M∑ti∈[Tj−1,Tj]𝔼​‖Zj,ti−Zj,tiπ‖2​hTotal​Err≔Err⁡(X)+Err⁡(Y)+Err⁡(Z).\displaystyle\operatorname{Err}(Z)\coloneqq\sum\_{j=1}^{M}\sum\_{t\_{i}\in[T\_{j-1},T\_{j}]}\mathbb{E}\left\|Z\_{j,t\_{i}}-Z\_{j,t\_{i}}^{\pi}\right\|^{2}h\qquad\operatorname{Total\ Err}\coloneqq\operatorname{Err}(X)+\operatorname{Err}(Y)+\operatorname{Err}(Z). |  |
...
where Vc​(t,xt;T2,K2)V\_{\text{c}}(t,x\_{t};T\_{2},K\_{2}) and Vp​(t,xt;T2,K2)V\_{\text{p}}(t,x\_{t};T\_{2},K\_{2}) denote the Black–Scholes call and put prices at time tt with underlying level xx, strike K2K\_{2} and expires at T2T\_{2}. The root-finding problems in ([5.5](https://arxiv.org/html/2601.18634v1#S5.E5 "In 5.1 Plain compound options with 𝑀=2 ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")) are solved efficiently via Brent’s method implemented in SciPy.

To implement ([2.4](https://arxiv.org/html/2601.18634v1#S2.E4 "In 2.4 The Compound BSDE method ‣ 2 The Compound BSDE Method ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), we follow Case [4](https://arxiv.org/html/2601.18634v1#S4 "4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") in Section [4](https://arxiv.org/html/2601.18634v1#S4 "4 Applications in derivatives pricing ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"). Under the risk-neutral measure, we set
...
Let Vc(M)​(t,xt)V\_{\text{c}}^{(M)}(t,x\_{t}) denote the price of the MM-fold compound call at current state (t,xt)(t,x\_{t}) for 0≤t<T10\leq t<T\_{1}. As reference values, we use the analytical expressions in [[35](https://arxiv.org/html/2601.18634v1#bib.bib35), [36](https://arxiv.org/html/2601.18634v1#bib.bib36)],
...
Table [2](https://arxiv.org/html/2601.18634v1#S5.T2 "Table 2 ‣ 5.2 𝑀-fold compound options ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") summarises the results. The accuracy is comparable to that in Subsection [5.1](https://arxiv.org/html/2601.18634v1#S5.SS1 "5.1 Plain compound options with 𝑀=2 ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") for both price and delta. Moreover, at fixed hh, performance remains essentially stable as MM increases, even though the loss contains more compounding terms. This suggests that, in this regime, the number of compounding conditions is not the main limitation of the method.
...
We compute the reference price and delta by applying a binomial tree with a sufficiently large number of time steps to the equivalent one-dimensional formulation. Under the d1d\_{1}-dimensional GBM dynamics ([5.1](https://arxiv.org/html/2601.18634v1#S5.E1 "In 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")), the geometric average
...
Table [3](https://arxiv.org/html/2601.18634v1#S5.T3 "Table 3 ‣ 5.3 Bermudan geometric basket put option ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") reports prices and deltas at t=0t=0 for varying d1d\_{1} with fixed N=100N=100, while Table [4](https://arxiv.org/html/2601.18634v1#S5.T4 "Table 4 ‣ 5.3 Bermudan geometric basket put option ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") reports results for varying NN with fixed d1=20d\_{1}=20. Due to space constraints, we report the range of the d1d\_{1} components of Δ1,0π\Delta\_{1,0}^{\pi}. Table [3](https://arxiv.org/html/2601.18634v1#S5.T3 "Table 3 ‣ 5.3 Bermudan geometric basket put option ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance") indicates that the method achieves good accuracy for both price and delta up to dimension d1=50d\_{1}=50, with relative errors remaining stable as the dimension increases. In Table [4](https://arxiv.org/html/2601.18634v1#S5.T4 "Table 4 ‣ 5.3 Bermudan geometric basket put option ‣ 5 Numerical examples ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance"), the relative errors for both price and delta decrease as NN increases, which is consistent with the convergence behaviour predicted by ([3.17](https://arxiv.org/html/2601.18634v1#S3.E17 "In Theorem 3.4 (Convergence of the Compound BSDE method). ‣ 3 Convergence Analysis ‣ The Compounded BSDE method: A fully-forward method for option pricing and optimal stopping problems in finance")).
